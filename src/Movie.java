//1.Paste the code below into 2 classes called Movie and NetflixQueue.Create your own
//class with a main() method that will use Movie and NetflixQueue to complete the following challenges:
